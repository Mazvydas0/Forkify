...
// all data we need to build our app is in state
export const state = {
  recipe: {},
  search: {
    query: '',
...
const createRecipeObject = function (data) {
  ...
  return {
    ...
    ...(recipe.key && { key: recipe.key }), // if left side doesn't exist, then nothing happens. If it is some value, then second part is executed and returned. Spread the object to put values here.
  };
};
